...
export PATH=/home/janakiraman/CUDA_RHEL_collections/cuda_12.4/bin:\$PATH
export LD_LIBRARY_PATH=/home/janakiraman/CUDA_RHEL_collections/cuda_12.4/lib64:\$LD_LIBRARY_PATH

##location of the UCX_1.17.x with support of cuda 12.4 and gdrcopy
export PATH=/home/janakiraman/UCX_collections/UCX_1.17.x_with_home_cuda_12.4_support/ucx-1.17.x/build/bin:\$PATH
export LD_LIBRARY_PATH=/home/janakiraman/UCX_collections/UCX_1.17.x_with_home_cuda_12.4_support/ucx-1.17.x/build/lib:\$LD_LIBRARY_PATH

##location of the OpenMPI-5.0.8 with UCX 1.17 and gdrcopy
export PATH=/home/janakiraman/OpenMPI_5.0.8_Collections/OpenMPI_with_ucx_and_gdrcopy/openmpi-5.0.8/build/bin:\$PATH
export LD_LIBRARY_PATH=/home/janakiraman/OpenMPI_5.0.8_Collections/OpenMPI_with_ucx_and_gdrcopy/openmpi-5.0.8/build/lib:\$LD_LIBRARY_PATH
    mpirun -np 2 \\ 
    --bind-to core \\
